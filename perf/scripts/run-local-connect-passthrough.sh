...
CONFIG_PATH="perf/config/local-connect-passthrough.yaml"
...
start_fixture "$FIXTURE_BIN" "passthrough" "${TARGET_HOST}:${TARGET_PORT}" "$TARGET_PATH" "$FIXTURE_ENV" "$FIXTURE_LOG"
source "$FIXTURE_ENV"
...
FIXTURE_ROOT_CA_PEM_B64=${ROOT_CA_PEM_B64:-}
EOF
